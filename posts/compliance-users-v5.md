...
In 2022, we launched a [tool](https://carbonplan.org/research/compliance-users) that makes it easier to see how companies participating in California’s cap-and-trade program use carbon offsets. The California Air Resources Board (CARB) released its [annual data update](https://ww2.arb.ca.gov/our-work/programs/cap-and-trade-program/cap-and-trade-program-data), which we’ve added to the tool.
